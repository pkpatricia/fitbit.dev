	...
	<div id="footer-cols-inner">
		...
		<div class="col3a">
			...
			<?php if ( !dynamic_sidebar( 'footer-column-1-widget-area' ) ) : ?>
						...
						<h2 class="footer-title">
							<?php _e('Footer Col Widget 1', 'fgreen'); ?>
						</h2><!-- .footer-title -->
						...
						<div class="textwidget">
							<?php _e('This is first footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #1.', 'fgreen'); ?>
						</div><!-- .textwidget -->
		...
		<div class="col3b">
			<?php if ( !dynamic_sidebar( 'footer-column-2-widget-area' ) ) : ?>
					...
					<h2 class="footer-title">
						<?php _e('Footer Col Widget 2', 'fgreen'); ?>
					</h2><!-- .footer-title -->
					...
					<div class="textwidget">
						<?php _e('This is second footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #2.', 'fgreen'); ?>
					</div><!-- .textwidget -->
		...
		<div class="col3c">
			<?php if ( !dynamic_sidebar( 'footer-column-3-widget-area' ) ) : ?>
					...
					<h2 class="footer-title">
						<?php _e('Footer Col Widget 3', 'fgreen'); ?>
					</h2><!-- .footer-title -->
					...
					<div class="textwidget">
						<?php _e('This is third footer widget area. To customize it, please navigate to Admin Panel -> Appearance -> Widgets and add widgets to Footer Column #3.', 'fgreen'); ?>
					</div><!-- .textwidget -->
